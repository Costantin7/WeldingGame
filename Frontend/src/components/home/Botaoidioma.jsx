  ...
  return (
    <div>
      <div className="flex font-serif">
        ...
        >
          {props.langprops === 0 && (
            <div className="flex items-center gap-[clamp(0.25rem,0.6rem,0.5rem)] text-[clamp(0.875rem,1.2rem,1rem)]">
              <img
          ...
          {props.langprops === 1 && (
            <div className="flex items-center gap-[clamp(0.25rem,1rem,0.5rem)] text-[clamp(0.875rem,1.2vw,1rem)]">
              <img
                className="w-[30vw] h-[3vh] "
