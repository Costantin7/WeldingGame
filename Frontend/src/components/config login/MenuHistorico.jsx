...
function MenuHistorico(props) {
  ...
  return (
    <div>
      ...
      ></div>
      <div className="p-6 pt-4 bottom-80 right-180 flex flex-col relative fixed z-50 bg-white border w-[50vw] h-[55vh]">
        <p className="text-xl font-semibold text-center mb-4">Histórico</p>
